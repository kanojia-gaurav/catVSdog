...
class _HomeState extends State<Home> {
  ...
  loadModel() async{
    await Tflite.loadModel(model:'assets/model_unquant.tflite', labels: 'assets/label.txt');
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                SizedBox(height:85),
                Text('Using cnn', style: TextStyle(color: Color(0xFFEDA28), fontSize: 18),),
                SizedBox(height: 6,),
                Text('Detect Dogs and Cat', style: TextStyle(color: Color(0xFFE99600),fontWeight: FontWeight.w500, fontSize:28 )),
                  SizedBox(height:40),
